...
public class TestBoard {
    ...
    public void testBoardConsistency() {
        ...
        Assert.assertEquals(t14.getToBoard().whitePlayer().getActivePieces().size(), calculatedActivesFor(t14.getToBoard(), Alliance.WHITE));
        Assert.assertEquals(t14.getToBoard().blackPlayer().getActivePieces().size(), calculatedActivesFor(t14.getToBoard(), Alliance.BLACK));
