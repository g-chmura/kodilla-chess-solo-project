...
public class TestFENParser {
    ...
    @Test
    public void testFEN1() throws IOException {
        final Board board = Board.createStandardBoard();
        final String fenString = Utilities.createFENFromGame(board);
        assertEquals(fenString, "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
    }

    @Test
    public void testFEN2() throws IOException {
        final Board board = Board.createStandardBoard();
        ...
        final String fenString = Utilities.createFENFromGame(t1.getToBoard());
        ...
        final String fenString2 = Utilities.createFENFromGame(t2.getToBoard());
