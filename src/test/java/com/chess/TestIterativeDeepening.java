...
public class TestIterativeDeepening {
    ...
    public void eloTest1() {
        ...
        builder.setMoveMaker(Alliance.BLACK);
        final Board board = builder.build();
        final String fen = Utilities.createFENFromGame(board);
    ...
    public void testQualityDepth7() {
        final Board board = Utilities.createGameFromFEN("4k2r/1R3R2/p3p1pp/4b3/1BnNr3/8/P1P5/5K2 w - - 1 0");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(7);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void testQualityTwoDepth6() {
        final Board board = Utilities.createGameFromFEN("6k1/3b3r/1p1p4/p1n2p2/1PPNpP1q/P3Q1p1/1R1RB1P1/5K2 b - - 0-1");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(6);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void testQualityThreeDepth6() {
        final Board board = Utilities.createGameFromFEN("r2r1n2/pp2bk2/2p1p2p/3q4/3PN1QP/2P3R1/P4PP1/5RK1 w - - 0 1");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(7);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void testQualityFourDepth6() {
        final Board board = Utilities.createGameFromFEN("r1b1k2r/pp3pbp/1qn1p1p1/2pnP3/3p1PP1/1P1P1NBP/P1P5/RN1QKB1R b KQkq - 2 11");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(6);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    @Test
    public void testChessLoss1() {
        final Board board = Utilities.createGameFromFEN("r2qkb1r/3p1pp1/p1n1p2p/1p1bP3/P2p4/1PP5/5PPP/RNBQNRK1 w kq - 0 13");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(7);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    @Test
    public void testChessLossWithID() {
        final Board board = Utilities.createGameFromFEN("r2qkb1r/3p1pp1/p1n1p2p/1p1bP3/P2p4/1PP5/5PPP/RNBQNRK1 w kq - 0 13");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(6);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void findMate() {
        final Board board = Utilities.createGameFromFEN("5rk1/5Npp/8/3Q4/8/8/8/7K w - - 0");
    ...
    public void runawayPawn() {
        final Board board = Utilities.createGameFromFEN("2k5/8/8/8/p7/8/8/4K3 b - - 0 1");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(5);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void testMackHackScenario() {
        final Board board = Utilities.createGameFromFEN("1r1k1r2/p5Q1/2p3p1/8/1q1p2n1/3P2P1/P3RPP1/4RK2 b - - 0 1");
    ...
    public void testAutoResponse() {
        final Board board = Utilities.createGameFromFEN("r2q1rk1/p1p2pp1/3p1b2/2p2QNb/4PB1P/6R1/PPPR4/2K5 b - - 0 1");
        final MoveStrategy iterativeDeepening = new IterativeDeepening(6);
        final Move bestMove = iterativeDeepening.execute(board);
        assertEquals(bestMove, Move.MoveFactory
                .createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("h5"), BoardUtils.INSTANCE.getCoordinateAtPosition("g6")));
