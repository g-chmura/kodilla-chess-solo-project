...
public final class Rook extends Piece {
    ...
    public Collection<Move> calculateLegalMoves(final Board board) {
        ...
        for (final int candidateOffset : CANDIDATE_MOVE_COORDINATES) {
            ...
            while (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                if (isColumnException(candidateOffset, candidateDestinationCoordinate)) {
                    break;
                }
    ...
    private static boolean isColumnException(final int currentCandidate, final int candidateDestinationCoordinate) {
