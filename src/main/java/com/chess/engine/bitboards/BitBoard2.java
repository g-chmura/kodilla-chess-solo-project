...
public class BitBoard2 {
    ...
    private BitBoard2(final long whitePawns,
    ...
    private static BitBoard2 standardBoard() {
        return createStandardBoard();
    }

    private static BitBoard2 createStandardBoard() {

        return new BitBoard2(WHITE_PAWNS_INITIAL_POSITIONS,
    ...
    public BitBoard2 calculateLegalMoves() {
        return new BitBoard2(calculateWhitePawnLegalMoves(),
                              calculateWhiteKnightLegalMoves(),
                              calculateWhiteBishopLegalMoves(),
                              calculateWhiteRookLegalMoves(),
                              calculateWhiteQueenLegalMoves(),
                              calculateWhiteKingLegalMoves(),
                              calculateBlackPawnLegalMoves(),
                              calculateBlackKnightLegalMoves(),
                              calculateBlackBishopLegalMoves(),
                              calculateBlackRookLegalMoves(),
                              calculateBlackQueenLegalMoves(),
                              calculateBlackKingLegalMoves());
    }

    private long calculateWhitePawnLegalMoves() {
    ...
    private long calculateBlackKnightLegalMoves() {
        long legals = 0L;
    ...
    private long calculateWhiteBishopLegalMoves() {
    ...
    private long calculateBlackBishopLegalMoves() {
        long legals = 0L;
    ...
    private long calculateWhiteRookLegalMoves() {
        long legals = 0L;
    ...
    private long calculateBlackRookLegalMoves() {
        long legals = 0L;
    ...
    private long calculateWhiteQueenLegalMoves() {
        long legals = 0L;
    ...
    private long calculateBlackQueenLegalMoves() {
        long legals = 0L;
    ...
    private long calculateWhiteKingLegalMoves() {
        long legals = 0L;
    ...
    private long calculateBlackKingLegalMoves() {
        long legals = 0L;
    ...
    public static void main(String[] args) {
        BitBoard2 v2 = standardBoard().calculateLegalMoves();
