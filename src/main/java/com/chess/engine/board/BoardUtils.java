...
public enum  BoardUtils {
    ...
    //back mapping from algebraic notation, like: put a8 to 0 etc.
    private Map<String, Integer> initializePositionToCoordinateMap() {
        final Map<String, Integer> positionToCoordinate = new HashMap<>();
        for (int i = START_TILE_INDEX; i < NUMBER_OF_TILES; i++) {
    ...
    public static boolean isValidTileCoordinate(final int coordinate) {
        return coordinate >= START_TILE_INDEX && coordinate < NUMBER_OF_TILES;
    }
    ...
    //Most Valuable Victim - Least Valuable Aggressor - capture moves
