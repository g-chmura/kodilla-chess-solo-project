...
class TakenPiecesPanel extends JPanel {
    ...
    private static final Dimension TAKEN_PIECES_PANEL_DIMENSION = new Dimension(80, 70);
    ...
    void redo(final MoveLog moveLog) {
        ...
        for (final Piece takenPiece : whiteTakenPieces) {
            try {
                final BufferedImage image = ImageIO.read(new File("src/main/resources/art/fancywarriors/"
